...
pub const SOURCE_MODEL_SCHEMA_VERSION: u8 = 9;
...
pub struct SourceModel {
    ...
    pub native_layouts: BTreeMap<String, NativeLayout>,
}
...
pub trait SchemaProvider {
    ...
    fn native_layout(&self, _cpp_name: &str) -> Option<&NativeLayout> {
        None
    }
...
impl SchemaProvider for SourceModel {
    fn native_layout(&self, cpp_name: &str) -> Option<&NativeLayout> {
        self.native_layouts.get(cpp_name)
    }
    fn find_struct(&self, path: &ObjectPath) -> Option<&StructSchema> {
...
mod tests {
    ...
    fn embedded_model_is_supported_engine_only_evidence() {
        ...
        let anim_sequence = model
            .find_class(&ObjectPath::new("/Script/Engine.AnimSequence"))
            .expect("generated AnimSequence schema");
        assert_eq!(
            anim_sequence.serialization,
            vec![
                SerializationOperation::TaggedProperties,
                SerializationOperation::ObjectGuid,
