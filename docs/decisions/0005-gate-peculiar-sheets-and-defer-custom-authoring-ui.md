...
Accepted on 2026-07-15. Amended on 2026-07-23 after the formula-free MIT core release, on
2026-07-30 for the reviewed `0.11.1` performance upgrade, and on 2026-09-10 for the reviewed
Solid 2-compatible `0.13.0` release.
...
Registry metadata checked on 2026-09-10 now reports:

- package: `peculiar-sheets`
- pinned version: `0.13.0`
- source: `https://github.com/peculiarnewbie/spreadsheets`
- license: `MIT`
- production dependencies: `@tanstack/virtual-core` and `better-result`
- framework peers: `solid-js@2.0.0-rc.7` and `@solidjs/web@2.0.0-rc.7`
